...
public class UpdateTimeTableServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isUpdated) {
            ...
            response.sendRedirect("faculty/viewTimeTable.jsp?success=Your Class is updated...");
        } else {
            // Update failed, show an error message
            response.sendRedirect("faculty/viewTimeTable.jsp?error=Technical Error! Try Again...");
        }
    }
