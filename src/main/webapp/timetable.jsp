...
<html lang="en">
    ...
    <body>
        ...
        <%
            ...
            // Determine the correct dashboard URL based on the "from" parameter
            if ("student".equals(from)) {
                dashboardURL = request.getContextPath() + "/student/dashboard.jsp";
            } else if ("faculty".equals(from)) {
        ...
        <div class="btn-container">
            <button class="btn-go-back" onclick="window.location.href = '<%= dashboardURL%>'">Go to Dashboard</button>
        </div>
